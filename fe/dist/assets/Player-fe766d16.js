import{i as hn,b as At,d as zo,s as To,F as qo,t as fn,u as Oo,c as ct,o as Do,e as jo}from"./index-aef7c9ae.js";import{c as Po,g as Ro}from"./_commonjsHelpers-725317a4.js";import{a as Yo}from"./axios-4a70c6fc.js";const Mo=fn('<div class="sidebar"><div class="item-control-wrap"><span class="item item-control">返回</span><span class="item item-control">更新'),Fo=fn('<span class="item">');function Uo(N){const[_,ee]=N.videoSignal;return(()=>{const Q=Mo(),v=Q.firstChild,W=v.firstChild,y=W.nextSibling;return W.addEventListener("click",()=>location.href="/"),y.addEventListener("click",()=>location.href="/add?s="+encodeURIComponent(N.name)),hn(Q,At(qo,{get each(){return N.file()},children:b=>(()=>{const u=Fo();return u.addEventListener("click",()=>ee(b.file)),hn(u,()=>b.name),zo(C=>{const w=b.file===_(),g=b.name;return w!==C._v$&&u.classList.toggle("active",C._v$=w),g!==C._v$2&&To(u,"title",C._v$2=g),C},{_v$:void 0,_v$2:void 0}),u})()}),null),Q})()}var ut={exports:{}};(function(N,_){(function(ee,Q){N.exports=Q()})(self,()=>(()=>{var ee={916:(y,b,u)=>{var C=u(471);y.exports=function(w){var g,p="",B=(w=w||{}).video,I=w.options,m=C.$escape,z=w.tran,O=w.icons,L=w.index,j=C.$each;return w.$value,w.$index,p+=`<div class="dplayer-mask"></div>
...
<button class="dplayer-mobile-play">
    `,p+=O.play,p+=`
</button>`}},568:(y,b,u)=>{var C=u(471);y.exports=function(w){var g="",p=(w=w||{}).enableSubtitle,B=w.subtitle,I=w.current,m=w.airplay,z=w.pic,O=C.$escape,L=w.screenshot,j=w.preload,D=w.url;return p=B&&B.type==="webvtt",g+=`
<video
    ...
    `),g+=`
    `,p&&(g+=`
    <track class="dplayer-subtrack" kind="metadata" default src="`,g+=O(typeof B.url=="string"?B.url:B.url[B.index].url),g+=`"></track>
    `),g+`
</video>`}},49:(y,b,u)=>{u.d(b,{Z:()=>B});var C=u(415),w=u.n(C),g=u(352),p=u.n(g)()(w());p.push([y.id,`:root {
...
[aria-label][data-balloon-pos] {
  ...
  [aria-label][data-balloon-pos][data-balloon-length="fit"]:after {
    width: 100%; }
`],sourceRoot:""}]);const B=p},685:(y,b,u)=>{u.d(b,{Z:()=>j});var C=u(415),w=u.n(C),g=u(352),p=u.n(g),B=u(49),I=u(80),m=u.n(I),z=new URL(u(831),u.b),O=p()(w());O.i(B.Z);var L=m()(z);O.push([y.id,`@keyframes my-face {
  2% {
